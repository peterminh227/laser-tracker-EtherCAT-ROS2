...
class CLaserTrackerUDP_senderCtrl : public ITcOCFCtrlImpl<CLaserTrackerUDP_senderCtrl, CLaserTrackerUDP_senderClassFactory>
{
public:
...
{
	HRESULT hr = E_FAIL;
	TRACE("LaserTrackerUDP_sender: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CLaserTrackerUDP_senderCtrl>;
